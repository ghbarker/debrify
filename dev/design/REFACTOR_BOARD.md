...
| V1-1 · Resume controller | review | `refactor/v1-1-resume-controller` | worker | `video_player_screen.dart` [resume hunks only], `lib/services/playback/resume_controller.dart`, resume tests | V1-0 (#75) | Extract `_resumeKey`…`_saveResume` to `ResumeController`. Leaves ≥ 650. Pin predates move. |
| V1-2 … V1-10 | queued | — | — | `video_player_screen.dart` | V1-1 | Sequential. Target ≤ 9 500. Do not start V1-2 until V1-1 merges. |
