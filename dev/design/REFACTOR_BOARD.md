...
| G1 · step 3 TitleOpener | review | `refactor/g1-title-opener` | worker | `lib/screens/search_screen.dart` [`_openItem` + menu building], `lib/screens/search/title_opener.dart`, tests | G1 step 2 | Pin + origin-diff. `search_screen.dart` 18 814 → 18 528. Do not start steps 4–5. Gate (c). |
