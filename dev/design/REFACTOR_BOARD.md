...
Baseline: `main` @ #73–#80 · Phase: **2 correction** (M1-0 + S2-2 review; G1'-2 + V1-2 in flight) · Last gate: 1 (Linux + Windows build/smoke **pass**; Android not run)
...
| M1-0 · WatchSession | review | `refactor/m1-0-watch-session` | worker | `magic_tv_screen.dart` [WatchSession field/sink hunks], `lib/screens/debrify_tv/watch_session.dart`, tests | P1b merged (#76) | **#81.** Leaves +12 ≈ 0. `ProgressSink` seam. Pin predates move. Watch flows / import / cache warmer not extracted. |
