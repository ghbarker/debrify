...
| S1 · settings registry | review | `refactor/s1-settings-registry` | worker-s1 | `settings_screen.dart` [nav tables, `_formatBackupSummary`/`_formatRestoreReport`], `lib/screens/settings/settings_tv_layout.dart`, `lib/screens/settings/widgets/settings_widgets.dart` | — | No dart format on settings_screen. Do not edit CODEMAP. |
