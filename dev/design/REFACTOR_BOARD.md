...
| M1-0 · WatchSession | review | `refactor/m1-0-watch-session` | worker | `magic_tv_screen.dart` [WatchSession field/sink hunks], `lib/screens/debrify_tv/watch_session.dart`, tests | P1b merged (#76) | Leaves ≈ 0. `ProgressSink` seam. Pin predates move. Watch flows / import / cache warmer not extracted. |
