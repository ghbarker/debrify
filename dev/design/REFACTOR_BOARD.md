...
## Current roadmap — September 6, main 4b33d4b2
...
- **Storage:** 9,963 → **2,066** (7,897 fewer)
- **Settings:** 7,905 → **2,903** (5,002 fewer)

Counted from actual merged main 4b33d4b2. These are physical file lines, not whole-project deletions or architectural completion. Keep this section at the top and refresh after merges. Overall completion is roughly **70% by architectural judgment**, as requested; not a measured score or a percentage derived from line counts.
...
- Production merge counter: **2 since completed gate896a168d** (#207, #208). Next production merge triggers a full gate. Docs192 does not increment the counter.
