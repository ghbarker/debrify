...
| H1 · Home row registry | review | `refactor/h1-home-row-registry` | worker-h1 | new `lib/services/home/**`, `search_screen.dart` [row-id hunks only], `lib/screens/settings/home_sections_filter_page.dart`, `lib/services/home_list_rows.dart`, `lib/services/home_row_order.dart` | — | No dart format on search_screen. Do not edit CODEMAP. Frozen row-id grammar; fake family appears in manager + board. |
