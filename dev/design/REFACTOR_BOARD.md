...
| G1'-2 · source dialogs | assigned | `refactor/g1p-2-source-binding-dialogs` | worker | `search_screen.dart` [dialog hunks], `lib/widgets/sources/source_binding_dialogs.dart` | G1'-1 | Leaves ~450. |
...
| V1-1 · resume controller | merged | `refactor/v1-1-resume-controller` | worker | `video_player_screen.dart` [resume hunks], `lib/services/playback/resume_controller.dart` | V1-0 | **#79.** Leaves 666. Adapter still `widget.*`. |
| V1-2 · identify-title sheet | assigned | `refactor/v1-2-identify-title-sheet` | worker | `video_player_screen.dart` [identify hunks], `lib/widgets/player/identify_title_sheet.dart` | V1-1 | Leaves ~700. |
